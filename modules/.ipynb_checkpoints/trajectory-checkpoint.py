...
class calculate_backward_trajectory:
    ...
    def __init__(self, ds, event_date, start_lev=700., start_time=12, lat_offset=0, lon_offset=0):
        ...
        self.center_date = pd.to_datetime(event_date, format='%Y-%m-%d')
        self.start_lat = ds.lat.values + lat_offset
        self.start_lon = ds.lon.values + lon_offset
        ...
        start_date = self.center_date - np.timedelta64(3,'D')
        end_date = self.center_date
